...
// Chaves válidas para evitar que categorias fantasmas quebrem o cálculo
...
export default function Summary() {
  ...
  // Função que calcula tudo em um único loop O(n) para máxima performance
  const getTotals = () => {
    const totals = {
      sum: 0,
      income: 0,
  ...
  // O useMemo memoriza o resultado e só recalcula se "transactions" mudar!
